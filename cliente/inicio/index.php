        ...
        <nav class="navegacion">
            <ul class="navegacion__lista">
                <li class="navegacion__li">
                    <a href="index.php" class="navegacion__link inicio">Inicio</a>
                </li>
                <li class="navegacion__li">
        ...
        <section class="content">
            <article class="article">
                ...
                <p>
                    ...
                    <a href="../sobre_nosotros/index.php">Leer más...</a>
                </p>
            </article>
            ...
            <article class="article">
                ...
                <p>
                    ...
                    <a href="../servicios/index.php">Leer más...</a>
                </p>
            </article>

            <article class="article1">
                <h2>¿Necesitas hablar con nosotros?</h2>
                <a href="../contacto/index.php">Ponte en contacto</a>
            </article>
        </section>
